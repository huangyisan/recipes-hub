...
import (
	...
	"github.com/huangyisan/recipes-hub/app/recipes/cmd/rpc/internal/server"
...
var configFile = flag.String("f", "etc/recipes.yaml", "the config file")
...
func main() {
	...
	s := zrpc.MustNewServer(c.RpcServerConf, func(grpcServer *grpc.Server) {
		__.RegisterRecipeServer(grpcServer, server.NewRecipeServer(ctx))
